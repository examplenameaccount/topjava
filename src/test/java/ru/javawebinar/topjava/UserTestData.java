...
public class UserTestData {
    ...
    public static User getNewWithTwoRole() {
        return new User(null, "Admin", "new1@gmail.com", "admin", Role.ROLE_ADMIN, Role.ROLE_USER);
    ...
    public static User getUpdatedWithTwoRole() {
        User updated = new User(ADMIN);
        updated.setName("UpdatedName");
        updated.setCaloriesPerDay(340);
        return updated;
    }
