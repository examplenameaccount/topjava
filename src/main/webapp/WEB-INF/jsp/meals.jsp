...
<div class="jumbotron pt-4">
    <div class="container">
        ...
        <form method="get" id="filterForm"
              style="background-color: #fff; border: 1px solid rgba(0,0,0,.125); padding: 20px;">
            <fieldset>
                <div class='row'>
                    <div class='col-sm-3'>
                        <div class='form-group'>
                            <label><spring:message code="meal.startDate"/>:</label>
                            <input name="startDate" value="${param.startDate}" class="form-control" type="date"/>
                        </div>
                    </div>
                    <div class='col-sm-3'>
                        <div class='form-group'>
                            <label><spring:message code="meal.endDate"/>:</label>
                            <input name="endDate" value="${param.endDate}" class="form-control" type="date"/>
                        </div>
                    </div>
                    <div class='col-sm-3'>
                        <div class='form-group'>
                            <label><spring:message code="meal.startTime"/>:</label>
                            <input name="startTime" value="${param.startTime}" class="form-control" type="time"/>
                        </div>
                    </div>
                    <div class='col-sm-3'>
                        <div class='form-group'>
                            <label><spring:message code="meal.endTime"/>:</label>
                            <input name="endTime" value="${param.endTime}" class="form-control" type="time"/>
                        </div>
                    </div>
                    <div class="container">
                        <button type="button" class="btn btn-primary"><a class="filter"><spring:message
                                code="meal.filter"/></a></button>
                        <button type="button" class="btn btn-primary"><a class="reset">Reset</a></button>
                    </div>
                </div>
            </fieldset>
        </form>
